...
{
    public class ProductManager : AbstractManager<ProductModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IEnumerable<ProductModel> GetByCategory(ProductCategoryModel category)
        {
        ...
        public double GetProductRemain(ProductModel product)
        {
